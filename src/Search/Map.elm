...
import Html
import Svg exposing (..)
import Svg.Attributes exposing (d, fill, height, points, stroke, viewBox, width, x, y)
...
maps =
    svg [ width "100%", height "500px", viewBox "0 0 600 500" ]
        ...
        , polygon [ fill "#fff", points "67.771,497.093 66.352,497.093 66.352,434.494 13.083,434.494 13.083,433.074 67.771,433.074 " ] []
        ]
